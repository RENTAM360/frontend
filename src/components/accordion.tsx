import {
  ...
  export function Faqs() {
    return (
      <section className="bg-[#F5F5F5] md:py-16 font-sans flex flex-col justify-center items-center">
        ...
        <Accordion type="single" collapsible className="w-full p-8 md:w-1/2">
            ...
            <AccordionTrigger className="no-underline text-[18px]">How do I rent equipment on Rentam360?</AccordionTrigger>
            ...
            <AccordionTrigger className="no-underline text-[18px]">Are the Equipment on Rentam360 verified?</AccordionTrigger>
            <AccordionContent className="text-[#898A8D]">
                Booking is simple search for your desired item, select your duration and complete your booking with few taps
            </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3" className="bg-white mb-2 px-6 rounded-[6px]">
            <AccordionTrigger className="no-underline text-[18px]">What payment method are accepted?</AccordionTrigger>
            <AccordionContent className="text-[#898A8D]">
                Booking is simple search for your desired item, select your duration and complete your booking with few taps
            </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4" className="bg-white px-6 rounded-[6px]">
            <AccordionTrigger className="no-underline text-[18px]">Can I cancel or modify my booking?</AccordionTrigger>
            <AccordionContent className="text-[#898A8D]">
                Booking is simple search for your desired item, select your duration and complete your booking with few taps
            </AccordionContent>
            </AccordionItem>
