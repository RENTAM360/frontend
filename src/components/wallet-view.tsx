...
export function WalletView() {
  ...
  const { data: walletHistory, isLoading: isLoadingHistory } =
    useGetWalletHistoryQuery({ page, limit: 50 });
  ...
  if (showWithdraw) {
    return (
      <WithdrawView onCancel={() => setShowWithdraw(false)} balance={balance} />
    );
  }
  ...
  //   if (statusLower === "deposit" || statusLower === "deposited")
  //     return "Deposit";
  ...
  const filteredTransactions = transactions
    .map((transaction) => ({
      ...
      title: transaction?.booking?.equipment?.name,
    ...
    .filter((transaction) => {
      ...
      if (activeTab === "rentals" && transaction.type !== "rental")
        return false;
      if (activeTab === "transactions" && transaction.type !== "transaction")
        return false;
      ...
      if (filter !== "All") {
        ...
        if (filterLower === "successful" && statusLower !== "successful")
          return false;
        if (filterLower === "pending" && statusLower !== "pending")
          return false;
        if (
          filterLower === "withdrawal" &&
          statusLower !== "withdrawal" &&
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M10.6654 8.5H5.33203C5.0587 8.5 4.83203 8.27333 4.83203 8C4.83203 7.72667 5.0587 7.5 5.33203 7.5H10.6654C10.9387 7.5 11.1654 7.72667 11.1654 8C11.1654 8.27333 10.9387 8.5 10.6654 8.5Z"
              fill="white"
            />
            <path
              d="M8 11.1666C7.72667 11.1666 7.5 10.9399 7.5 10.6666V5.33325C7.5 5.05992 7.72667 4.83325 8 4.83325C8.27333 4.83325 8.5 5.05992 8.5 5.33325V10.6666C8.5 10.9399 8.27333 11.1666 8 11.1666Z"
              fill="white"
            />
          </svg>
          Add account
