...
const mockEquipmentData = {
  ...
  callToAction:
    "Rent this stylish Camry today and enjoy a seamless driving experience! Book now!",
  guarantees: [
    {
      icon: (
        <svg
...
export default function EquipmentDetailsClient({
  equipmentId,
}: EquipmentIdProps) {
  ...
  const openDirections = () => {
    router.push(`/dashboard/equipment/${equipmentId}/location`);
  };
      ...
      {isFullscreen && (
        <div className="fixed inset-0 h-screen w-screen bg-black/95 flex items-center justify-center touch-none z-[9999] transition-opacity duration-300 opacity-100">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {isLocalFileUri(equipmentData.media[selectedImage] || "") ? (
                <Image
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full bg-white p-4 rounded-lg lg:flex-2">
          ...
          <div className="mt-4 text-[12px]">
            ...
            <p className="mt-2 text-xs text-[#979797] whitespace-pre-line">
        ...
        <div className="w-full lg:flex-1 rounded-lg">
          ...
          <div className="bg-white rounded-lg p-6 mb-6">
            ...
            <div className="mb-6">
              ...
              <span className="text-base text-[#979797] ml-2">Per day</span>
            </div>
            ...
            >
              <div className="flex items-center gap-4">
                <div className="relative h-10 w-10 overflow-hidden rounded-full">
                  {isLocalFileUri(equipmentData.owner.avatarUrl || "") ? (
                    <Image
                      src={equipmentData.owner.avatarUrl || "/user.svg"}
                    ...
                    <div className="relative h-8 w-8 overflow-hidden flex justify-center items-center bg-white rounded-full flex-shrink-0">
                      {latestFeedback?.feedbackBy?.avatar ? (
                        isLocalFileUri(
                          ...
                          <Image
                            src={
                              latestFeedback?.feedbackBy?.avatar || "/user.svg"
                            }
                            alt="User Avatar"
                            fill
                            unoptimized
