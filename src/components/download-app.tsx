...
export default function DownloadAppSection() {
    return (
      <section className="relative font-sans w-full">
        ...
        {/* Content */}
        <div className="relative z-10 overflow-hidden rounded-[22px] flex flex-col items-center justify-center md:pt-20 md:pb-16 md:px-16 md:m-16 bg-[#403E3D] h-full text-center">
            {/* Background Image */}
            <div className="absolute inset-0">
                <Image
            ...
            <p className="text-[13.7px] text-[#FFFFFFCC] max-w-xl mb-8">
