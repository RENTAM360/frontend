...
export function EquipmentCard({
  ...
  return (
    <section>
        <Link href={`/dashboard/equipment/${id}`} className="relative flex flex-col w-[280px] flex-shrink-0">
