        ...
        >
          ...
          <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
            <Suspense fallback={<div>Loading...</div>}>
              <NavItem href="/admin" icon={DashboardIcon} label="Dashboard" setIsSidebarOpen={setIsSidebarOpen} />
              <NavItem href="/admin/users" icon={UsersIcon} label="Users" setIsSidebarOpen={setIsSidebarOpen} />
              <NavItem href="/admin/messages" icon={MessagesIcon} label="Messages" setIsSidebarOpen={setIsSidebarOpen} />
              <NavItem href="/admin/reports" icon={ReportsIcon} label="Reports" setIsSidebarOpen={setIsSidebarOpen} />
              <NavItem href="/admin/settings" icon={SettingsIcon} label="Settings" setIsSidebarOpen={setIsSidebarOpen} />
              <NavItem href="/admin/transactions" icon={TransactionsIcon} label="Transactions" setIsSidebarOpen={setIsSidebarOpen} />
