  ...
  const onSubmit: SubmitHandler<LoginFormInputs> = async (data) => {
    ...
    try {
      ...
      const profileRes = await fetch(
        `${process.env.NEXT_PUBLIC_AUTH_API_URL}/profile/me`,
        {
          headers: {
        ...
        <div className="absolute inset-0 p-10 flex max-w-md flex-col justify-between text-white z-10">
          ...
          <div className="mt-auto">
            ...
            <p className="text-sm md:text-base text-[#FFFFFF]/65 max-w-sm">
              Access what you need, when you need it without the cost of
              ownership. From heavy equipment to everyday tools, Rentam360 makes
              renting simple, affordable, and sustainable.
            </p>
          </div>
        </div>
        <div className="absolute inset-0 bg-[#424647]/80" />{" "}
        {/* dark overlay */}
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <a
              ...
              className="text-sm text-right text-primary ml-2 whitespace-nowrap"
            >
              Forgot password
            </a>
