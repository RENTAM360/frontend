...
export default function PaymentStatusPage() {
    ...
    useEffect(() => {
        if (!paymentStatus) {
            enqueueSnackbar("Invalid payment response. Please check your transaction history.", { variant: "error" });
            setIsLoading(false);
            return;
        }

        const isSuccessful = paymentStatus.toLowerCase() === 'success' || paymentStatus.toLowerCase() === 'successful';
