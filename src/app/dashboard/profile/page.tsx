...
export default function ProfilePage() {
  ...
  const [uploadTarget, setUploadTarget] = useState<"cover" | "avatar" | null>(
    null
  );
  ...
  const accountStages = useMemo<{
    ...
    if (!profile)
      return { details: "gray", verification: "gray", bank: "gray" };
    ...
    const isVerificationPending =
      (profile.isNinVerify || profile.isBvnVerify) && !isVerificationComplete;
  ...
  const fullName = `${capitalize(profile?.firstName)} ${capitalize(
    profile?.lastName
  )}`;
    ...
    <div className="container font-sans mx-auto md:px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full bg-white mb-4 rounded-b-3xl md:rounded-b-none rounded-t-3xl md:w-1/3">
          ...
          <div className="mt-16 px-8">
            ...
            <div className="flex justify-center items-center mt-4">
              ...
              <Link
                href={
                  feedbackCount > 0
                    ? `/dashboard/user/owner/${userId}/reviews`
                    : "#"
                }
            ...
            {profile?.bio && (
              <p className="mt-4 text-muted-foreground text-[12px] leading-relaxed">
                {profile?.bio}
              </p>
            )}
            ...
            <div className="mt-6 space-y-6">
              {profile?.address && (
                <div className="flex items-center gap-3 text-sm">
                  <div className="rounded-full bg-[#F6FEF9] p-2">
                    ...
                    >
                      <path
                        d="M8.00016 10.1964C6.40266 10.1964 5.09766 8.89893 5.09766 7.29393C5.09766 5.68893 6.40266 4.39893 8.00016 4.39893C9.59766 4.39893 10.9027 5.69643 10.9027 7.30143C10.9027 8.90643 9.59766 10.1964 8.00016 10.1964ZM8.00016 5.52393C7.02516 5.52393 6.22266 6.31893 6.22266 7.30143C6.22266 8.28393 7.01766 9.07893 8.00016 9.07893C8.98266 9.07893 9.77766 8.28393 9.77766 7.30143C9.77766 6.31893 8.97516 5.52393 8.00016 5.52393Z"
                        fill="#12B76A"
                      />
                      <path
                        d="M7.99928 16.6388C6.88928 16.6388 5.77178 16.2188 4.90178 15.3863C2.68928 13.2563 0.244278 9.85885 1.16678 5.81635C1.99928 2.14885 5.20178 0.506348 7.99928 0.506348C7.99928 0.506348 7.99928 0.506348 8.00678 0.506348C10.8043 0.506348 14.0068 2.14885 14.8393 5.82385C15.7543 9.86635 13.3093 13.2563 11.0968 15.3863C10.2268 16.2188 9.10928 16.6388 7.99928 16.6388ZM7.99928 1.63135C5.81678 1.63135 3.01178 2.79385 2.26928 6.06385C1.45928 9.59635 3.67928 12.6413 5.68928 14.5688C6.98678 15.8213 9.01928 15.8213 10.3168 14.5688C12.3193 12.6413 14.5393 9.59635 13.7443 6.06385C12.9943 2.79385 10.1818 1.63135 7.99928 1.63135Z"
                        fill="#12B76A"
                      />
                    </svg>
                  </div>
              ...
              >
                <div className="rounded-full bg-[#F6FEF9] p-2">
                  ...
                  >
                    <path
                      d="M12.6667 6.83333H12V5.16667C12 3.32667 10.5067 1.83333 8.66667 1.83333C6.82667 1.83333 5.33333 3.32667 5.33333 5.16667V6.83333H4.66667C4.3 6.83333 4 7.13333 4 7.5V13.1667C4 13.5333 4.3 13.8333 4.66667 13.8333H12.6667C13.0333 13.8333 13.3333 13.5333 13.3333 13.1667V7.5C13.3333 7.13333 13.0333 6.83333 12.6667 6.83333ZM8.66667 2.83333C9.77333 2.83333 10.6667 3.72667 10.6667 4.83333V6.83333H6.66667V4.83333C6.66667 3.72667 7.56 2.83333 8.66667 2.83333ZM12.6667 13.1667H4.66667V7.5H12.6667V13.1667Z"
                      fill="#12B76A"
                    />
                    <path
                      d="M8.66667 10.1667C9.03333 10.1667 9.33333 9.86667 9.33333 9.5C9.33333 9.13333 9.03333 8.83333 8.66667 8.83333C8.3 8.83333 8 9.13333 8 9.5C8 9.86667 8.3 10.1667 8.66667 10.1667Z"
                      fill="#12B76A"
                    />
                  </svg>
                </div>
              ...
              >
                <div className="rounded-full bg-[#F6FEF9] p-2">
                  ...
                  >
                    <path
                      d="M12.0423 7.29158H7.29232V12.0416H5.70898V7.29158H0.958984V5.70825H5.70898V0.958252H7.29232V5.70825H12.0423V7.29158Z"
                      fill="#12B76A"
                    />
                  </svg>
                </div>
          ...
          <div className="bg-white rounded-lg border border-[#97979726] m-4 p-6">
            ...
            <p className="text-sm text-gray-600 mb-8">
              Provide your data and link bank account to receive payments for
              your items
            </p>
            ...
            <Tabs defaultValue="details" className="w-full">
              <TabsList className="grid grid-cols-3 place-content-center mb-8">
                <TabsTrigger value="details" className="">
                  <div className="flex flex-col items-center">
                    <div
                      className={`flex justify-center items-center h-8 w-8 rounded-full ${getStageStyle(
                        accountStages.details
                      )}`}
                    >
                ...
                <TabsTrigger value="verification" className="">
                  <div className="flex flex-col items-center">
                    <div
                      className={`flex justify-center items-center h-8 w-8 rounded-full ${getStageStyle(
                        accountStages.verification
                      )}`}
                    >
                ...
                {accountStages.details === "green" ? (
                  <div className="bg-green-50 p-4 rounded-lg">
                    <p className="text-green-700 text-sm">
                      ✓ Your profile details are complete and verified.
                    </p>
                  </div>
                ) : (
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-gray-700 text-sm">
                      Please complete all required profile fields: first name,
                      last name, address, country, and bio.
                    </p>
                  </div>
                )}
              </TabsContent>
              <TabsContent value="verification" className="mt-0">
                {accountStages.verification === "green" ? (
                  <div className="bg-green-50 p-4 rounded-lg">
                    <p className="text-green-700 text-sm">
                      ✓ Both NIN and BVN verification are complete.
                    </p>
                  </div>
                ) : accountStages.verification === "orange" ? (
                  <div className="bg-[#F7D15F17] p-4 rounded-lg">
                    <p className="text-yellow-700 text-sm">
                      Verification is in progress. Please complete both NIN and
                      BVN verification.
                    </p>
                  </div>
                ) : (
          ...
          <div className="bg-white rounded-lg overflow-hidden">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                >
                  <path
                    d="M7.9987 15.1667C4.04536 15.1667 0.832031 11.9534 0.832031 8.00004C0.832031 4.04671 4.04536 0.833374 7.9987 0.833374C8.27203 0.833374 8.4987 1.06004 8.4987 1.33337C8.4987 1.60671 8.27203 1.83337 7.9987 1.83337C4.5987 1.83337 1.83203 4.60004 1.83203 8.00004C1.83203 11.4 4.5987 14.1667 7.9987 14.1667C11.3987 14.1667 14.1654 11.4 14.1654 8.00004C14.1654 7.72671 14.392 7.50004 14.6654 7.50004C14.9387 7.50004 15.1654 7.72671 15.1654 8.00004C15.1654 11.9534 11.952 15.1667 7.9987 15.1667Z"
                    fill="#F04438"
                  />
                  <path
                    d="M8.6663 7.83329C8.53964 7.83329 8.41297 7.78662 8.31297 7.68662C8.11964 7.49329 8.11964 7.17329 8.31297 6.97995L13.7796 1.51329C13.973 1.31995 14.293 1.31995 14.4863 1.51329C14.6796 1.70662 14.6796 2.02662 14.4863 2.21995L9.01964 7.68662C8.91964 7.78662 8.79297 7.83329 8.6663 7.83329Z"
                    fill="#F04438"
                  />
                  <path
                    d="M14.6653 5.05337C14.392 5.05337 14.1653 4.82671 14.1653 4.55337V1.83337H11.4453C11.172 1.83337 10.9453 1.60671 10.9453 1.33337C10.9453 1.06004 11.172 0.833374 11.4453 0.833374H14.6653C14.9386 0.833374 15.1653 1.06004 15.1653 1.33337V4.55337C15.1653 4.82671 14.9386 5.05337 14.6653 5.05337Z"
                    fill="#F04438"
                  />
                </svg>
                <span>Log out</span>
        ...
        <div className="w-full md:w-2/3 md:mx-4">
          ...
          {viewMode === "items" && (
            <>
              <h2 className="text-2xl font-bold mt-3 md:mt-0 mb-6">
                Listed items
              </h2>
